...
public class FileSelectionModel extends DomainModel implements
		ModifiesInkscapeCommand {

	/** A globally unique identifier for the file selection model */
	public static final String GLOBAL_NAME = "models.file_selection";
	/**
	...
	/**
	 * Constructs a <code>FileSelectionModel</code> specifying the Inkscape
	 * command builder.
	 */
	public FileSelectionModel(InkscapeCommandBuilder command) {
		setCommand(command);
	}
